...
from .plot import PInfo, Plot


class ResizablePInfo(PInfo):
    def __init__(self, sch, width = 100, height = 100):
        super().__init__(sch)
        self.width = width
        self.height = height
...
class ResizablePlot(Plot):
    ...
    def plot(self, strategy, figid=0, numfigs=1, iplot=True,
        ...
        self.pinf = ResizablePInfo(self.p.scheme, self.width, self.height)
